...
| [`src/apricot/`](../src/apricot/) | Package root containing core agent runtime (`agent/`), LLM provider abstractions (`models/`), repository and Git inspection tools (`tools/`), and module skeletons. |
