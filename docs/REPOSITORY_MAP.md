...
| :--- | :--- |
| [`.github/workflows/ci.yml`](file:///C:/Users/hp/Desktop/PAPERS/neuropole/apricot-neo/.github/workflows/ci.yml) | GitHub Actions CI matrix across Python 3.10–3.13 validating ruff, mypy, and pytest with `uv`. |
| [`.env.example`](file:///C:/Users/hp/Desktop/PAPERS/neuropole/apricot-neo/.env.example) | Environment variable template for API keys (`GROQ_API_KEY`), endpoints, and log settings. |
